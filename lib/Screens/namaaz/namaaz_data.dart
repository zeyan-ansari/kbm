...
The time of the Night Prayer begins after midnight; yet, it is recommended to perform it as near as possible to dawn.

The Night Prayer consists of eight units of prayer; each two alone. Taslim should be said at the end of each two units with the intention of offering the Night Prayer. It is advisable to recite Surah Ikhlas after Surah al-Faatehah in 1st rakaat at least once and at most thirty times (if there is time). In the 2nd rakaat recite Surah al-Kafirun after Surah al-Faatehah.

In the other six units of the prayer, one may recite any Surah he chooses. However, it is sufficiently acceptable to recite Surah al-Faatehah and Surah Ikhlas in each unit of the Night Prayer. It is also permissible to recite Surah al-Faatehah alone.

NAMAZ E SHAFA

When you accomplish the eight-unit Night Prayer, you may then offer the two-unit Shafa Prayer. It has two rakats. Recite it after finish Namaz e tahajjud. In the first rakat, after Surah Fatehah recite Surah al-Ikhlas or Surah al-Falaq. In the second rakat, recite only Surah Fatehah and Surah al-Nas and finish the namaz. Qunoot is not recited in this namaz. After finishing the namaz, recite Tasbeeh e Janab e Fatima (s.a.) and supplicate to Allah. The supplication will be surely granted for this is the right time for the grants of prayers. Then after performing Sajdah e Shukr recite Namaz e Witr.

NAMAZ E WITR

This namaz has one rakat. In this prayer recite Surah Fatehah then Surah al-Ikhlas, Surah al-Falaq, Surah al-Nas three times each. Then raise your hands and recite the following Qunoot.

لَاۤ اِلٰهَ اِلَّا اللّٰهُ الْحَلِيْمُ الْكَرِيْمُ لَاۤ اِلٰهَ اِلَّا اللّٰهُ الْعَلِىُّ الْعَظِيْمُ سُبْحَانَ اللّٰهِ رَبِّ السَّمٰوَاتِ السَّبْعِ وَ رَبِّ الْاَرَضِيْنَ السَّبْعِ وَ مَا فِيْهِنَّ وَ مَا بَيْنَهُنَّ وَ مَا فَوْقَهُنَّ وَ مَا تَحْتَهُنَّ وَ هُوَ رَبُّ الْعَرْشِ الْعَظِيْمِ وَ سَلَامٌ عَلَي الْمُرْسَلِيْنَ وَالْحَمْدُ لِلّٰهِ رَبِّ الْعَالَمِيْنَ يَا اَللهُ الَّذِيْ لَيْسَ كَمِثْلِهِ شَيْءٌ وَ هُوَ السَّمِيْعُ الْبَصِيْرُ وَصَلِّ عَلٰى مُحَمَّدٍ وَّ اٰلِ مُحَمَّدٍ۔

It is also recommended, during Qunut, to weep, or even try to weep, out of fear of Almighty Allah and fear of His chastisement. It is also desirable to pray Almighty Allah for the good of one's brethren-in-faith, whether dead or alive, in the following words:

اَللّٰهُمَّ اغْفِرْ لِهٰذَا۔۔۔۔۔
...
سُبُّوْحٌ قُدُّوْسٌ رَبُّ الْمَلَاۤئِكَةِ وَالرُّوْحِ۔
...
This namaz has one rakat. In this prayer recite Surah Fatehah the Surah al-Ikhlas, Surah al-Falaq, Surah al-Nas three times each. Then raise your hands and recite the following Qunoot.
...
HAAZAA MAKAAMUL AA-E'ZE BEKA MENAN-NAAR
...
You may then sit and recite Ayah al-Kursi after which you may return to the prostration position and repeat the aforesaid five times again.""",
    ...
    "audioUrl": "http://docs.google.com/uc?export=open&id=1BPe8DSm0Y_IBz-gZDJG55yCyFyP4CwtS",
  },
  {
    "title": """Namaz-E-Ayaat""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1oilSNX0w8PDbAvykru2aW7eYgNGOjLoJ",
    "translation":
...
After making niyyat to offer Namaz-e-Ayaat, a person is allowed to say takbir and recite Surah al-Hamd and then divide the verses of the other Surah into five parts, and recite one verse or more or less, and thereafter perform the Ruku. He should then stand up and recite another part of the Surah (without reciting Surah al-Hamd) and then perform another Ruku. He should repeat this action, and finish that Surah before performing the fifth Ruku. For example, he may say: Bismillahir Rahmanir Rahim with the niyyat of reciting Surah al-Ikhlas, and perform the Ruku. He should then stand up and say, Qul huwallahu Ahad, and perform another Ruku. He should then stand up and say, Allahus Samad, and perform the third Ruku. Thereafter he should stand up again and say, Lam yalid walam yulad, and perform the fourth Ruku. Then he should stand up again and say, Walam yakullahu Kufuwan ahad, and then perform two Sajdah and then rise for the second Rak'at, the same way as the first Rak'at. At the end, he should recite tashahhud and Salam after the two Sajdah. It is also permissible to divide a Surah into less than five parts. In that event, however, it is necessary that when the Surah is over, one should recite Surah al-Hamd before the next Ruku.""",
  ...
  {
    "title": """Namaz-E-Ghufaylah""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1w0T7VUDfw5WqmelUgPG2I53xUmkZlSgL",
    "arabic":
    """You should offer this Prayer in the period between the Sunset (maghrib) and the Evening (Isha) Prayers. This prayer consists of two units in the first of which you should recite, after Surah al-Faatehah, the following verses (Surah al-Anbiya’ 21:87-88):

وَ ذَا النُّوْنِ اِذْ ذَهَبَ مُغَاضِبًا فَظَنَّ اَنْ لَنْ نَقْدِرَ عَلَيْهِ فَنَادٰى فِي الظُّلُمَاتِ اَنْ لَّاۤ اِلٰهَ اِلَّا اَنْتَ سُبْحَانَكَ اِنِّي كُنْتُ مِنَ الظَّالِمِيْنَ فَاسْتَجَبْنَا لَهُ وَ نَجَّيْنَاهُ مِنَ الْغَمِّ وَ كَذٰلِكَ نُنْجِي الْمُؤْمِنِيْنَ ۔

In the second unit, you should recite, after Surah al-Faatehah, the following verse (6:59):

وَعِنْدَهٗ مَفَاتِحُ الْغَيْبِ لَا يَعْلَمُهَاۤ اِلَّا هُوَ‌ؕ وَيَعْلَمُ مَا فِى الْبَرِّ وَالْبَحْرِ‌ؕ وَمَا تَسْقُطُ مِنْ وَّرَقَةٍ اِلَّا يَعْلَمُهَا وَلَا حَبَّةٍ فِىْ ظُلُمٰتِ الْاَرْضِ وَلَا رَطْبٍ وَّلَا يَابِسٍ اِلَّا فِىْ كِتٰبٍ مُّبِيْنٍ‏(95)

After that, you should raise your both hands for Qunut, saying:

اَللّٰهُمَّ اِنِّي اَسْاَلُكَ بِمَفَاتِحِ الْغَيْبِ الَّتِيْ لَا يَعْلَمُهَا اِلَّا اَنْتَ اَنْ تُصَلِّيَ عَلٰى مُحَمَّدٍ وَ اٰلِهِ وَ اَنْ تَفْعَلَ بِيْ كَذَا وَ كَذَا۔

You may then mention your needs.

Then, say the following:

اَللّٰهُمَّ اَنْتَ وَلِيُّ نِعْمَتِيْ وَ الْقَادِرُ عَلٰى طَلِبَتِيْ تَعْلَمُ حَاجَتِيْ فَاَسْاَلُكَ بِحَقِّ مُحَمَّدٍ وَ اٰلِهِ عَلَيْهِ وَ عَلَيْهِمُ السَّلَامُ لَمَّا قَضَيْتَهَا لِيْ۔
...
O Allah, You are the source of the graces that I have, You have the power to respond to my request, and You know my needs; I therefore beseech You in the name of Muhammad and his Household, peace be upon him and them, to grant me my needs.

You may then pray to Him for your personal needs, for it has been narrated that anyone who offers this prayer and supplicates Almighty Allah will have his requests granted.""",
    "transliteration": """Namaz-E-Ghufaylah

You should offer this Prayer in the period between the Sunset (maghrib) and the Evening (Isha) Prayers. This prayer consists of two units in the first of which you should recite, after Surah al-Faatehah, the following verses (Surah al-Anbiya’ 21:87-88):

WA ZAN-NOONE IZ-ZAHABA MOGHAZEBAN, FA-ZAN-NAN AN LAN NAKDERA ALAYHE FA-NAADAA FIZ-ZOLOMAATE AN-LAA-ELAAHA ILLAA ANTA SUBHAANAKA INNEE KUNTO MENAZ ZAALEMINA, FASTAJABNAA LAHU WA-NAJJAYNAAHO MENAL GHAMME WA KAZAALEKA NUNJIL MOMENEEN.

In the second unit, you should recite, after Surah al-Faatehah, the following verse (6:59):

WA I'NDAHU MAFAATEHUL GHAYBE LAA YA'LAMOHAA ILLAA HOWA, WA YA'LAMO MAA FIL BARRE WAL BAHRE, WA MAA TASQOTO MIN WARAQATIN ILLAA YA'LAMOHAA WA LAA HABBATIN FEE ZOLOMAATIL ARZE WA LAA RATBIWN WA LAA YAABESIN ILLAA FEE KETAABIM MOBEEN.

After that, you should raise your both hands for Qunut, saying:

ALLAAHUMMA SALLE A'LAA MOHAMMADIWN WA AALE MOHAMMADIN. ALLAAHUMMA INNEE AS-ALOKA BE MAFAATEHIL GHAYBILLATEE LAA YA'LAMOHAA ILLAA ANTA, AN TOSALLEYA A'LAA MOHAMMADIWN WA AALE MOHAMMADIN WA AN TAF-A'LA BEE...

You may then mention your needs.

Then, say the following:

ALLAAHUMMA ANTA WALIYYO NE'MATEE WAL QAADERO A'LAA TALEBATEE TA'LAMO HAAJATEE FA-AS-ALOKA BE-HAQQE MOHAMMADIWN WA AALE MOHAMMADIN A'LAYHE WA A'LAYHEMUS SALAAMO LAMMAA QAZAYTAHAA LEE...

You may then pray to Him for your personal needs, for it has been narrated that anyone who offers this prayer and supplicates Almighty Allah will have his requests granted.""",
  },
  {
    "title": """Namaz-E-Kamilah""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1q4KcY8M7M8_ng7kjWADPDhjssXipupws",
    "arabic":
    """Twentieth: Excluding the Friday supererogatory (mustahab / nafilah) (mustahab / nafilah) Prayer (Nafilat al-Jumu’ah), many other optional prayers are reported to be offered on Fridays. Although the majority of these prayers are not dedicated to Fridays, it is highly recommended to offer them on Fridays.

One of these prayers is al-Salat al-Kamilah (The Perfect Prayer) that has been mentioned by many master scholars through numerous authentic series of reporters from Imam Ja’far al-Sadiq on the authority of his honorable fathers on the authority of the Holy Prophet - Allah’s peace and blessings be upon them all. In this connection, the Holy Prophet (s.a.w.a.) is reported to have said: As for anyone who, before midday (zohr) on Fridays, offers a four-unit prayer and recites the following in each unit: (1) Surah al-Faatehah ten times, (2) Surah al-Nas (No. 114) ten times, (3) Surah al-Falaq (No. 113) ten times, (4) Surah al-Tawheed (No. 112) ten times, (5) Surah al-Kafirun (No. 109) ten times, (6) Ayah al-Kursi (2:155) ten times, [And, according to another narration, (7) Surah al-Qadr (No. 97) ten times, (8) Ayat Shahidallah (3:18-19) ten times,] and, after the accomplishment of the prayer,
...
سُبْحَانَ اللهِ وَالْحَمْدُلِلّٰهِ وَ لَاۤ اِلٰهَ اِلَّا اللهُ وَاللهُ اَكْبَرُ وَ لَا حَوْلَ وَلَا قُوَّةَ اِلَّا بِاللهِ الْعَلِیِّ الْعَظِیْمِ۔
...
One of these prayers is al-Salat al-Kamilah (The Perfect Prayer) that has been mentioned by many master scholars through numerous authentic series of reporters from Imam Ja’far al-Sadiq on the authority of his honorable fathers on the authority of the Holy Prophet - Allah’s peace and blessings be upon them all. In this connection, the Holy Prophet (s.a.w.a.) is reported to have said: As for anyone who, before midday on Fridays, offers a four-unit prayer and recites the following in each unit: (1) Surah al-Faatehah ten times, (2) Surah al-Nas (No. 114) ten times, (3) Surah al-Falaq (No. 113) ten times, (4) Surah al-Tawheed (No. 112) ten times, (5) Surah al-Kafirun (No. 109) ten times, (6) Ayah al-Kursi (2:155) ten times, [And, according to another narration, (7) Surah al-Qadr (No. 97) ten times, (8) Ayat Shahidallah (3:18-19) ten times,] and, after the accomplishment of the prayer, (1) repeats the following statement one hundred times:

I implore for Allah’s forgiveness.

(2) repeats the following litany one hundred times:

All glory be to Allah; all praise be to Allah; there is no god save Allah; Allah is the Greatest; and there is no power and no might save with Allah, the All- high, the All-Great.
...
It has been narrated on the authority of al-Harith al-HaMadani that Imam Ali Ameer al-Momineen (a.s.) said: If possible, offer on Fridays ten units of prayer with perfect genuflection (ruku’) and prostration (sujud) repeating the following litany one hundred times between each couple (i.e. two) of units:

All glory be to Allah and with the Praising of Him.
...
It has been authentically narrated that Imam al-Sadiq (a.s.) said,One who recites Surahs Ibrahim (No. 14) and al-Hijr (No. 15) altogether in a two-unit prayer on Fridays will be saved from poverty, insanity, and misfortunes forever.""",
  ...
  {
    "title": """Namaz-E-Mayyat""",
    "arabic":
    """It is traditional that the performer of the Deceased Prayer should stand in the middle of the dead body of a man and in front of the breast of the dead body of a woman. This is the most familiar rule. Besides, the performer of the Deceased Prayer should take off the shoes and must intend performing the Deceased Prayer. He must then repeat the takbir statement five times. It is also traditional that he raises his hands to the level of his ears while uttering these statements. Familiarly, he should say the following words after uttering the first takbir statement:
...
اَللّٰهُمَّ اجْعَلْهُ لِاَبَوَيْهِ وَ لَنَا سَلَفًا وَ فَرَطًا وَ اَجْرًا۔""",
  ...
  {
    "title": """Namaz-E-Nawafil""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=15fepeNGjSHyH6Hm4OTdiFGibR0ZcSi9j",
    "translation": """NAFILAH OF FAJR
...
Like the morning prayers, in sitting position.""",
  ...
  {
    "title": """Namaz-E-Wahshat""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1s5LdMsWCnTq3z1VDPQTsj3Tkaft_SkgQ",
    "arabic":
    """The prayer to be offered at the burial night consists of two units. In the first unit, Surah al-Faatehah and Ayah al-Kursi are recited. In the second unit, Surah al-Faatehah is recited one time and Surah al-Qadr repeated ten times. When you say the Taslim statement, you may say the following supplication:
...
If you do so, Almighty Allah will immediately send one thousand angels to the grave of that individual; each angel carrying a dress and a garment. Moreover, Almighty Allah will expand his grave, saving him from tightness up to the day when the Trumpet will be blown. As for the one who has offered this prayer, he will be given rewards as many as every thing touched by the sunlight and he will be raised forty ranks.""",
  ...
  {
    "title": """Namaz-E-Maghferat-E-Waledain""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1EPBXg6xNyzAE_SCRJPO9_LIcquZDhPYq",
    "arabic":
...
رَبِّ اغْفِرْلِىْ وَ لِوَالِدَىَّ وَ لِلْمُؤْمِنِيْنَ يَوْمَ يَقُوْمُ الْحِسَابُ۔

In the second unit, Surah al-Faatehah is recited once and the following supplicatory prayer is repeated ten times:

رَبِّ اغْفِرْلِىْ وَ لِوَالِدَىَّ وَ لِمَنْ دَخَلَ بَيْتِىَ مُؤْمِنًا وَّ لِلْمُؤْمِنِيْنَ وَ الْمُؤْمِنَاتِ۔

When the prayer is accomplished (by uttering the Taslim statement), the following supplicatory prayer is repeated ten times:

رَبِّ ارْحَمْهُمَا كَمَا رَبَّيَانِىْ صَغِيْرًا۔""",
    "translation": """Namaz-E-Maghferat-E-Waledain

The prayer for the parents is of two units. In the first unit, Surah al-Faatehah is recited once and the following supplicatory prayer is repeated ten times:

O my Lord! Grant me protection and my parents and the believers on the day when the reckoning shall come to pass!
...
O my Lord! Have compassion on them, as they brought me up (when I was) little.""",
    "transliteration": """Namaz-E-Maghferat-E-Waledain

The prayer for the parents is of two units. In the first unit, Surah al-Faatehah is recited once and the following supplicatory prayer is repeated ten times:

RABBIGH FIR LEE WA LE WAALEDAYYA WA LIL MO'MENEENA YAWMA YAQOOMUL HESAAB.

In the second unit, Surah al-Faatehah is recited once and the following supplicatory prayer is repeated ten times:

RABBIGH FIR LEE WA LE WAALEDAYYA WA LEMAN DHAKHALA BAYTEE MO'MENAWN WA LIL MO'MENEENA WAL MO'MENAAT.

When the prayer is accomplished (by uttering the Taslim statement), the following supplicatory prayer is repeated ten times:

RABBIR HAM-HOMAA KAMAA RABBAYAANEE SAGHEERAA.""",
  },
  {
    "title": """Namaz-E-Jaffar-E-Tayyar""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1_eaioPrDylOQxbs4u-o-p-iXbgsOl_em",
    "arabic":
...
Many narrations have mentioned emphatically fasting on these three days and then performance of a two-unit prayer at midday (zohr) on Friday so that one’s requests are granted.""",
    "translation": """Namaz of Jafar-E-Tayyar
...
Many narrations have mentioned emphatically fasting on these three days and then performance of a two-unit prayer at midday on Friday so that one’s requests are granted.""",
    "transliteration": """Namaz of Jafar-E-Tayyar

Ja’far al-Tayyar’s Prayer is as precious as gold, since it is the most magnificent recommended devotional rite. Altogether with its great merits the most important of which is that it erases major sins, this prayer has been reported through authenticated chain of authority. The best time of its performance is the first hours of daylight on Fridays. It consists of four units with two Tashahhuds (i.e. the part of prayers in which the two creeds of Islam are recited) and two Taslims. In the first unit, Surahs al-Faatehah and al-Zalzalah are recited, in the second, Surahs al-Faatehah and al-’Adiyat, in the third, Surahs al-Faatehah and al-Nasr, and in the fourth, Surahs al-Faatehah and al-Tawheed. In each unit, after the recitation of the Surahs and before the genuflection (Ruku’), the following litany (Tasbihat) should be repeated fifteen times:

SUBHAANAL LAAHE WAL HAMDO LILLAAHE WA LAA ELAAHA ILLAL LAAHO WALLAAHO AKBARO.

The same litany (Tasbihat) is repeated, yet ten times only, during the Ruku’, after the Ruku’ while standing erect, during the prostration (Sujud), after the first Sajdah, during the second Sajdah, and after the second Sajdah. The same thing is repeated in all of the four units of the prayer. Hence, the litany will have been repeated three hundred times.

Shaykh al-Kulayni has narrated that Imam Ja’far al-Sadiq (a.s.) said to Abu-Sa’id al-Mada’ini, “May I teach you something that you should recite in Ja’far al-Tayyar’s Prayer?” As the man answered in the affirmative, the Imam (a.s.) said: After you say the Tasbihat in the second Sajdah of the fourth unit, say the following litany:

SUBHAANA MAN LABESAL I'ZZA WAL WAQAARA SUBHAANA MAN TA-A'TTAFA BIL MAJDE WA TAKARRAMA BEHI SUBHAANA MAL LAA YAM-BAGHIT TASHBEEHA ILLAA LAHU SUBHAANA MAN AHSAA KULLA SHAY-IN I'LMOHU SUBHAANA ZIL QUDRATE WAL KARAME ALLAAHUMMA INNEE AS-ALOKA BE MA-A'AQEDE MIN A'RSHEKA WA MUNTAHAR RAHMATE MIN KETAABEKA WAS-MEKAL A-A'ZAME WA KALEMAATEKAT TAAAM-MATIL LATEE TAMMAT SIDQAN WA A'DLAN SALLE A'LAA MOHAMMADIWN WA AHLE BAYTEHI WAF-A'L BEE KAZAA WA KAZAA.
...
ALLAAHUMMA INNEE AFTATEHUL QAWLA BE HAMDEKA WA ANTEQO BIS-SANAAA-E A'LAYKA WA OMAJJEDOKA WA LAA GHAAYATA LE-MADHEKA WA USNEE A'LAYKA WA MAN YABLOGHO GHAA-YATA SANAAA-EKA WA AMADA MAJDEKA WA ANNAA LE-KHALEEQATEKA KUNHO MA'REFATE MAJDEKA WA AYYA ZAMANIN LAM TAKUN MAMDOOHAN BE-FAZLEKA MAWSOOFAN BE MAJDEKA A'WWAADAN A'LAL MUZNEBEENA BE-HILMEKA TAKHALLAFA SUKKAANO ARZEKA A'N TAA-A'TEKA FA-KUNTA A'LAYHIM A'TOOFAN BE JOODEKA JAWAADAN BE FAZLEKA A'WWAADAN BE KARAMEKA YAA LAA ELAAHA ILLAA ANTAL MANNAANO ZUL JALAALE WAL IKRAAM.
...
Al-Mufaddal then added: Imam Ja’far al-Sadiq (a.s.) then said to me,If you have a significant request and you want it to be granted, you may offer this prayer, say this supplication, and implore Almighty Allah to respond to you. If you do, it will be granted, Allah willing.""",
  },
  {
    "title": """Eid Namaz""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=17nqdizbGKuMrRFFsORyrsclziJhEDlYn",
    "arabic":
    """It is recommended to offer the ‘Id Prayer (Salat al-’Id), which consists of two units. In the first unit, recite Surah al-Faatehah and Surah al-A’la. After the recitation of these Surahs, say the Takbir statement (i.e. Allahu-akbar) five times and raise your hands for Qunut after each Takbir, saying:

اَللّٰهُمَّ اَهْلَ الْكِبْرِيَاۤءِ وَ الْعَظَمَةِ وَ اَهْلَ الْجُوْدِ وَ الْجَبَرُوْتِ وَ اَهْلَ الْعَفْوِ وَ الرَّحْمَةِ وَ اَهْلَ التَّقْوٰى وَ الْمَغْفِرَةِ اَسْاَلُكَ بِحَقِّ هٰذَا الْيَوْمِ الَّذِيْ جَعَلْتَهُ لِلْمُسْلِمِيْنَ عِيْدًا وَ لِمُحَمَّدٍ صَلَّى اللّٰهُ عَلَيْهِ وَ اٰلِهِ ذُخْرًا وَ شَرَفًا وَ مَزِيْدًا اَنْ تُصَلِّيَ عَلٰى مُحَمَّدٍ وَ اٰلِ مُحَمَّدٍ وَ اَنْ تُدْخِلَنِيْ فِيْ كُلِّ خَيْرٍ اَدْخَلْتَ فِيْهِ مُحَمَّدًا وَ اٰلَ مُحَمَّدٍ وَ اَنْ تُخْرِجَنِيْ مِنْ كُلِّ سُوْۤءٍ اَخْرَجْتَ مِنْهُ مُحَمَّدًا وَ اٰلَ مُحَمَّدٍ صَلَوَاتُكَ عَلَيْهِ وَ عَلَيْهِمْ اَجْمَعِيْنَ اَللّٰهُمَّ اِنِّيْۤ اَسْاَلُكَ خَيْرَ مَا سَاَلَكَ مِنْهُ عِبَادُكَ الصَّالِحُوْنَ وَ اَعُوْذُ بِكَ فِيْهِ مِمَّا اسْتَعَاذَ مِنْهُ عِبَادُكَ الصَّالِحُوْنَ (الْمُخْلِصُوْنَ)

You may then say the Takbir statement for the sixth time, do the genuflection (ruku'), and prostrate yourself (sujud). When you stand up for the second unit, recite Surah al-Faatehah and Surah al-Shams and then say the Takbir statement four times only raising the hands for Qunut after each statement. After that, say the fifth Takbir statement and continue the prayer. After accomplishment of the prayer, say the famous Tasbih al-Zahra’(a.s.).

Narrations have mentioned many supplicatory prayers to be said after the ‘Id Prayer; rather, the best of them may be the 46th supplication of al-Sahifah al-Kamilah al-Sajjadiyyah
...
It is also recommended to offer the ‘Id Prayer outdoors, directly on the ground without putting a carpet or any other thing under the feet, to return from a way other than the one taken in the coming, and to pray Almighty Allah for accepting the acts of one’s brethren-in-faith.""",
  ...
  {
    "title": """Namaz Hadiyah Masoomeen""",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1Lu66ZBrAV_7YarlyiKss6OdTpGdHT9mT",
    "arabic":
...
اَللّٰهُمَّ اَنْتَ السَّلَامُ وَ مِنْكَ السَّلَامُ وَ اِلَيْكَ يَعُوْدُ السَّلَامُ حَيِّنَا رَبَّنَا مِنْكَ بِالسَّلَامِ اَللّٰهُمَّ اِنَّ هٰذِهِ الرَّكَعَاتِ هَدِيَّةٌ مِنَّا اِلٰى وَلِيِّكَ۔

You should mention the name of the Imam to whom these units are dedicated.

فَصَلِّ عَلٰى مُحَمَّدٍ وَ اٰلِهٖ وَ بَلِّغْهُ اِيَّاهَا وَاَعْطِنِىْ اَفْضَلَ اَمَلِىْ وَ رَجَاۤئِىْ فِيْكَ وَ فِىْ رَسُوْلِكَ صَلَوَاتُكَ عَلَيْهِ وَ اٰلِهٖ۔

You may now pray Almighty Allah for any thing you wish.""",
  },
  {
    "title": "Namaz of Holy Prophet",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1zkJF6SaAHAw0NSxfHXQVY0EgejKTjc1o",
    "arabic":
...
Offer a two-unit prayer reciting in each unit Surah al-Faatehah once and Surah al-Qadr fifteen times. When you come to the Ruku’ (genuflection (ruku')), repeat it (i.e. Surah al-Qadr) fifteen times; when you raise your body after the Ruku’, recite it fifteen times; when you do the Sujud (prostration), repeat it fifteen times; when you raise your head from the Sujud, repeat it fifteen times; when you do the second prostration, repeat it fifteen times; and when you raise your head from the second prostration, repeat it fifteen times. When you finish your prayer, you will have all your sins forgiven by Almighty Allah and you will have all your requests granted for you. The supplication that should be said thereafter is as follows:

لَاۤ اِلٰهَ اِلَّا اللهُ رَبُّنَا وَ رَبُّ اٰبَاۤئِنَا الْاَوَّلِيْنَ لَاۤ اِلٰهَ اِلَّا اللهُ اِلٰهًا وَاحِدًا وَ نَحْنُ لَهُ مُسْلِمُوْنَ لَاۤ اِلٰهَ اِلَّا اللهُ لَا نَعْبُدُ اِلَّاۤ اِيَّاهُ مُخْلِصِيْنَ لَهُ الدِّيْنَ وَ لَوْ كَرِهَ الْمُشْرِكُوْنَ لَاۤ اِلٰهَ اِلَّا اللهُ وَحْدَهُ وَحْدَهُ وَحْدَهُ اَنْجَزَ وَعْدَهُ وَ نَصَرَ عَبْدَهُ وَ اَعَزَّ جُنْدَهُ وَ هَزَمَ الْاَحْزَابَ وَحْدَهُ فَلَهُ الْمُلْكُ وَ لَهُ الْحَمْدُ وَ هُوَ عَلٰى كُلِّ شَيْ‏ءٍ قَدِيْرٌ اَللّٰهُمَّ اَنْتَ نُوْرُ السَّمَاوَاتِ وَ الْاَرْضِ وَ مَنْ فِيْهِنَّ فَلَكَ الْحَمْدُ [وَ لِلّٰهِ الْمُلْكُ وَ الْحَمْدُ] وَ اَنْتَ قَيَّامُ السَّمَاوَاتِ وَ الْاَرْضِ وَ مَنْ فِيْهِنَّ فَلَكَ الْحَمْدُ وَ اَنْتَ الْحَقُّ وَ وَعْدُكَ الْحَقُّ [حَقٌ‏]، وَ قَوْلُكَ حَقٌّ وَ اِنْجَازُكَ حَقٌّ وَ الْجَنَّةُ حَقٌّ وَ النَّارُ حَقٌّ [وَ اَنْتَ الْحَقُّ‏] اَللّٰهُمَّ لَكَ اَسْلَمْتُ وَ بِكَ اٰمَنْتُ وَ عَلَيْكَ تَوَكَّلْتُ وَ بِكَ خَاصَمْتُ وَ اِلَيْكَ حَاكَمْتُ يَا رَبِّ يَا رَبِّ يَا رَبِّ اغْفِرْ لِيْ مَا قَدَّمْتُ وَ اَخَّرْتُ وَ اَسْرَرْتُ وَ اَعْلَنْتُ اَنْتَ اِلٰهِيْ لَاۤ اِلٰهَ اِلَّا اَنْتَ صَلِّ عَلٰى مُحَمَّدٍ وَ اٰلِ مُحَمَّدٍ وَ اغْفِرْ لِيْ وَ ارْحَمْنِي وَ تُبْ عَلَيَّ اِنَّكَ اَنْتَ التَّوَّابُ الرَّحِيْمُ ۔""",
    "translation": """NAMAZ OF HOLY PROPHET
...
سُبْحَانَ ذِي الْعِزِّ الشَّامِخِ الْمُنِيْفِ سُبْحَانَ ذِي الْجَلَالِ الْبَاذِخِ الْعَظِيْمِ سُبْحَانَ ذِي الْمُلْكِ الْفَاخِرِ الْقَدِيْمِ سُبْحَانَ مَنْ لَبِسَ الْبَهْجَةَ وَ الْجَمَالَ سُبْحَانَ مَنْ تَرَدَّى بِالنُّوْرِ وَ الْوَقَارِ سُبْحَانَ مَنْ يَرٰى اَثَرَ النَّمْلِ فِي الصَّفَا سُبْحَانَ مَنْ يَرٰى وَقْعَ الطَّيْرِ فِي الْهَوَاۤءِ سُبْحَانَ مَنْ هُوَ هٰكَذَا لَا هٰكَذَا غَيْرُهُ۔
...
يَا مَنْ لَيْسَ غَيْرَهُ رَبٌّ يُدْعٰى يَا مَنْ لَيْسَ فَوْقَهُ اِلٰهٌ يُخْشٰى يَا مَنْ لَيْسَ دُوْنَهُ مَلِكٌ يُتَّقٰى يَا مَنْ لَيْسَ لَهُ وَزِيْرٌ يُّؤْتٰى يَا مَنْ لَيْسَ لَهُ حَاجِبٌ يُرْشٰى يَا مَنْ لَيْسَ لَهُ بَوَّابٌ يُغْشٰى يَا مَنْ لَا يَزْدَادُ عَلٰى كَثْرَةِ السُّؤَالِ اِلَّا كَرَمًا وَ جُوْدًا وَ عَلٰى كَثْرَةِ الذُّنُوْبِ اِلَّا عَفْوًا وَ صَفْحًا صَلِّ عَلٰى مُحَمَّدٍ وَ اٰلِ مُحَمَّدٍ۔

And then one may mention one’s personal requests.""",
    "translation": """NAMAZ OF LADY FATIMAH ZEHRA (S.A.)
...
O He besides Whom there is no lord to be supplicated! O He above Whom there is no god to be feared! O He except Whom there is no master to be revered! O He Who has no counselor to be approached! O He Who has no attendant to be bribed! O He Who has no doorkeeper to be visited (secretly)! O He Who gives not but generously and liberally no matter how many the demands are and deals not with numerous sins but mercifully and kindly! Send blessings upon Muhammad and his Household...

And then one may mention one’s personal requests.""",
  },
  {
    "title": "Namaz of Maula Ali(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1I6M6ycXFfHUtduKQ26TmS1FOovBXRQOR",
    "arabic":
    """Shaykh al-Tusi and Sayyid Ibn Tawus have recorded that Imam Ja’far al-Sadiq(a.s.) said: One who offers the four-unit prayer of Imam Ali Ameer al-Momineen(a.s.) will be as free of sins as newborns and will have all his requests granted. In the first unit, recite Surah al-Faatehah once and repeat Surah al-Tawheed fifty times. On accomplishment, say the following litany of Imam Ali, peace be upon him:

سُبْحَانَ مَنْ لَا تَبِيْدُ مَعَالِمُهُ سُبْحَانَ مَنْ لَا تَنْقُصُ خَزَاۤئِنُهُ سُبْحَانَ مَنْ لَا اضْمِحْلَالَ لِفَخْرِهِ سُبْحَانَ مَنْ لَا يَنْفَدُ مَا عِنْدَهُ سُبْحَانَ مَنْ لَا انْقِطَاعَ لِمُدَّتِهِ سُبْحَانَ مَنْ لَا يُشَارِكُ اَحَدًا فِي اَمْرِهِ سُبْحَانَ مَنْ لَاۤ اِلٰهَ غَيْرُهُ

Thereafter, say the following supplicatory prayer:

يَا مَنْ عَفَا عَنِ السَّيِّئَاتِ وَ لَمْ يُجَازِ بِهَا اِرْحَمْ عَبْدَكَ يَا اَللهُ نَفْسِيْ نَفْسِيْ اَنَا عَبْدُكَ يَا سَيِّدَاهُ اَنَا عَبْدُكَ بَيْنَ يَدَيْكَ اَيَا رَبَّاهُ، اِلٰهِيْ بِكَيْنُوْنَتِكَ يَا اَمَلَاهُ يَا رَحْمَانَاهُ يَا غِيَاثَاهُ عَبْدُكَ عَبْدُكَ لَا حِيْلَةَ لَهُ يَا مُنْتَهٰى رَغْبَتَاهُ يَا مُجْرِيَ الدَّمِ فِي عُرُوْقِي [عَبْدُكَ‏] يَا سَيِّدَاهُ يَا مَالِكَاهُ اَيَا هُوَ اَيَا هُوَ يَا رَبَّاهُ عَبْدُكَ عَبْدُكَ لَا حِيْلَةَ لِيْ وَ لَا غِنٰى بِيْ عَنْ نَفْسِيْ وَ لَا اَسْتَطِيْعُ لَهَا ضَرًّا وَ لَا نَفْعًا وَ لَا اَجِدُ مَنْ اُصَانِعُهُ تَقَطَّعَتْ اَسْبَابُ الْخَدَاۤئِعِ عَنِّي وَ اضْمَحَلَّ كُلُّ مَظْنُوْنٍ عَنِّي اَفْرَدَنِي الدَّهْرُ اِلَيْكَ فَقُمْتُ بَيْنَ يَدَيْكَ هٰذَا الْمَقَامَ يَا اِلٰهِيْ بِعِلْمِكَ كَانَ هٰذَا كُلُّهُ فَكَيْفَ اَنْتَ صَانِعٌ بِيْ وَ لَيْتَ شِعْرِيْ كَيْفَ تَقُوْلُ لِدُعَاۤئِي اَ تَقُوْلُ نَعَمْ اَمْ تَقُوْلُ لَا، فَاِنْ قُلْتَ لَا فَيَا وَيْلِيْ يَا وَيْلِيْ يَا وَيْلِيْ يَا عَوْلِيْ يَا عَوْلِيْ يَا عَوْلِيْ يَا شِقْوَتِيْ يَا شِقْوَتِيْ يَا شِقْوَتِيْ يَا ذُلِّيْ يَا ذُلِّيْ يَا ذُلِّيْ اِلٰى مَنْ وَ مِمَّنْ اَوْ عِنْدَ مَنْ اَوْ كَيْفَ اَوْ مَا ذَا اَوْ اِلٰى اَيِّ شَيْ‏ءٍ اَلْجَاُ وَ مَنْ اَرْجُوْ وَ مَنْ يَجُوْدُ عَلَيَّ بِفَضْلِهِ حِيْنَ تَرْفُضُنِيْ يَا وَاسِعَ الْمَغْفِرَةِ وَ اِنْ قُلْتَ نَعَمْ كَمَا هُوَ الظَّنُّ بِكَ وَ الرَّجَاۤءُ لَكَ فَطُوْبٰى لِيْ اَنَا السَّعِيْدُ وَ اَنَا الْمَسْعُوْدُ فَطُوْبٰى لِيْ وَ اَنَا الْمَرْحُوْمُ، يَا مُتَرَحِّمُ يَا مُتَرَئِّفُ يَا مُتَعَطِّفُ يَا مُتَجَبِّرُ [مُتَحَنِّنُ‏] يَا مُتَمَلِّكُ يَا مُقْسِطُ لَا عَمَلَ لِيْ اَبْلُغُ بِهِ نَجَاحَ حَاجَتِيْ اَسْاَلُكَ بِاسْمِكَ الَّذِيْ جَعَلْتَهُ فِي مَكْنُوْنِ غَيْبِكَ وَ اسْتَقَرَّ عِنْدَكَ فَلَا يَخْرُجُ مِنْكَ اِلٰى شَيْ‏ءٍ سِوَاكَ اَسْاَلُكَ بِهِ وَ بِكَ وَ بِهِ فَاِنَّهُ اَجَلُّ وَ اَشْرَفُ اَسْمَاۤئِكَ لَا شَيْ‏ءً لِيْ غَيْرُ هٰذَا وَ لَا اَحَدَ اَعْوَدُ عَلَيَّ مِنْكَ يَا كَيْنُوْنُ يَا مُكَوِّنُ يَا مَنْ عَرَّفَنِيْ نَفْسَهُ يَا مَنْ اَمَرَنِيْ بِطَاعَتِهِ يَا مَنْ نَهَانِيْ عَنْ مَعْصِيَتِهِ وَ يَا مَدْعُوُّ يَا مَسْئُوْلُ يَا مَطْلُوْبًا اِلَيْهِ رَفَضْتُ وَصِيَّتَكَ الَّتِيْ اَوْصَيْتَنِيْ وَ لَمْ اُطِعْكَ وَ لَوْ اَطَعْتُكَ فِيْمَا اَمَرْتَنِيْ لَكَفَيْتَنِيْ مَا قُمْتُ اِلَيْكَ فِيْهِ وَ اَنَا مَعَ مَعْصِيَّتِيْ لَكَ رَاجٍ، فَلَا تَحُلْ بَيْنِيْ وَ بَيْنَ مَا رَجَوْتُ يَا مُتَرَحِّمًا لِيْ اَعِذْنِيْ مِنْ بَيْنِ يَدَيَّ وَ مِنْ خَلْفِيْ وَ مِنْ فَوْقِي وَ مِنْ تَحْتِي وَ مِنْ كُلِّ جِهَاتِ الْاِحَاطَةِ بِيْ اَللّٰهُمَّ بِمُحَمَّدٍ سَيِّدِيْ وَ بِعَلِيٍّ وَلِيِّيْ وَ بِالْاَئِمَّةِ الرَّاشِدِيْنَ عَلَيْهِمُ السَّلَامُ اِجْعَلْ عَلَيْنَا صَلَوَاتِكَ وَ رَأْفَتَكَ وَ رَحْمَتَكَ وَ اَوْسِعْ عَلَيْنَا مِنْ رِّزْقِكَ وَ اقْضِ عَنَّا الدَّيْنَ وَ جَمِيْعَ حَوَاۤئِجِنَا يَا اَللهُ يَا اَللهُ يَا اَللهُ اِنَّكَ عَلٰى كُلِّ شَيْ‏ءٍ قَدِيْرٌ۔
...
اَللّٰهُمَّ صَلِّ عَلَى النَّبِيِّ الْعَرَبِيِّ وَ اٰلِهِ۔""",
    "translation":
...
O He who overlooks sins and does not inflict punishment in return, (please) have mercy on Your servant, O Allah, that is I myself, that is I myself. I am Your servant, O my Chief, I am Your servant; I am at Your disposal; O my Lord. O my God, in the name of Your Being, O my Hope, O my All-beneficent, O my Supporter, Your servant, Your servant, has no strategy. O Ultimate of my desire! O He Who makes blood run into the veins of Your slave! O my Chief, O my Master! O He Who is Unique! O He Who is Unique! O my Lord! I—Your servant, Your servant- have no strategy and I cannot avail myself and I have no control over loss or over profit. I do not find anyone from whom I may seek help; so, all profitable avenues have been blocked, and all my expectations have turned into disappointments. Helpless and forsaken I came to You, So, I have presented myself before You in this current stand. O my God, You are aware of all that which I speak about. So, how would You deal with me? If I but knew how would You dispense with my prayer? Would You say, ‘Yes’ or ‘No’? If You say ‘No,’ then I am ruined! I am ruined! I am ruined! Woe to me! Woe to me! Woe to me! Oh my misery! Oh my misery! Oh my misery! Oh my ill-luck! Oh my ill-luck! Oh my ill- luck! To whom? By Whom? From whom? How? What? In which place to take shelter? For whom shall I hope? Who shall bestow upon me with his favor when You forsake me? O Liberal in forgiveness! But if You say ‘Yes,’ as I expect You to say and as I desire from You, then joy is for me, I am successful, I am happy; then joy is for me, I will receive (Your) mercy. O Ever-merciful! O Ever-compassionate! O Ever-sympathetic! O Ever- commiserating! O Ever-sovereign! O Just! I lack any act due to which I can attain achievement of my desire. I thus beseech You in the name of Your Name which You have reserved in the innermost of Your Hidden Knowledge and it has thus settled with You so firmly that nothing of it can come out from You to any other thing. I beseech You by it and by You, for it is certainly the most exalted and honored of Your Names. I have nothing to mention except this, and no one can be more beneficent to me than You. O Absolute Being! O Creator of creation! O He Who has introduced Himself to me! O He Who has commanded me to obey Him! O He Who has warned me against disobeying Him! O He Who is besought! O He Who is pleaded! O He Who is desired! I have overlooked Your instructions, which You gave me and have not obeyed You. If I obeyed You in what You have ordered me, You would certainly grant my requests that I am presenting before You. In spite of my transgression, I am hopeful for You. So, do not let my hope remain unfulfilled. O He Who always has mercy upon me, keep me safe, under Your protection, from (all evils that are) before me, behind me, above me, below me, and from all sides that surround me. O Allah, [I beseech You] in the name of Muhammad, my master, and [in the name of] 'Ali, my chief, and [in the names of] the orthodox Imams (leaders), peace be upon them, (please) bestow upon us with Your blessings, compassions, and mercy; and grant us expansive shares of Your sustenance; and help us repay our debts and settle all our needs, O Allah, O Allah, O Allah. Verily, You have full power over all things.
...
O Allah, send blessings to the Arab Prophet and on his Household.""",
  ...
  {
    "title": "Namaz of Maula Hasan(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1tHF4lnAK_xSEEA-qCAO5y0yQncbYVnoT",
    "translation":
  ...
  {
    "title": "Namaz of Maula Hussain(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1RIMZsXaHiYK28D-F1Ju2Wt5XpiC_gF9K",
    "translation":
    """This prayer consists of four units in each of which Surah al-Faatehah and Surah al-Tawheed are repeated twenty-five times. While genuflecting, Surah al-Faatehah and Surah al-Tawheed are repeated ten times. So is done when one raises his head after the genuflection (ruku') and while prostrating oneself and between the two prostrations.""",
  },
  {
    "title": "Namaz of Maula Zainul Aabedin(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1IlWfiAN7Cn71UgR4ovh6BZ9GYA1y_ld0",
    "translation":
  ...
  {
    "title": "Namaz of Maula Baqir(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=10x0azFO1EO6C-_0TzfOlF_I5LdyjoxYN",
    "arabic":
...
All Glory be to Allah,All Praise be to Allah,There is no God but Allah,And Allah is Greatest""",
    "transliteration":
    """This prayer consists of two units in each of which Surah al-Faatehah is recited once and the following litany is repeated one hundred times:

SUBHAANALLAHI WALHAMDO LILLAHI WALAA ILAAHA ILLALAHO WALLAHO AKBAR""",
  },
  {
    "title": "Namaz of Maula Sadiq(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=13GSaJYc23goROOmcmidCZtRkSx07TujR",
    "translation":
    """This prayer consists of two units in each of which Surah al-Faatehah is recited once and Ayat al-Tashahhud 100 times.""",
  },
  {
    "title": "Namaz of Maula Kazim(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1dumEiV2SyifVe5_LU_IBQuAb9PPMylqE",
    "translation":
  ...
  {
    "title": "Namaz of Maula Reza(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1lrEZXRzWuW5AfpJnqttVLZMtnF2PYvlp",
    "translation":
    """This prayer consists of six units in each of which Surah al-Faatehah is recited once and Surah al-Insan or Dahr is repeated ten times.""",
  },
  {
    "title": "Namaz of Maula Taqi(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=12YOgLV2e4Hb2WNQkje1FylqpuvQg0VQi",
    "translation":
  ...
  {
    "title": "Namaz of Maula Naqi(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1GwGn63GY8jJcm8auKEYRraNoXcNoZCNS",
    "translation":
    """This prayer consists of two units in the first of which Surahs al-Faatehah and Yasin are recited and in the second of which Surahs al-Faatehah and al-Rahman are recited.""",
  },
  {
    "title": "Namaz of Maula Askari(A.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1gH4Md4fMnGb3TWXyRlFwnbQnxh8c3AD-",
    "translation":
    """This prayer consists of four units in the first two of which Surah al-Faatehah is recited once and Surah al-Zalzalah is repeated fifteen times, and the last two of which Surah al-Faatehah is recited once and Surah al-Tawheed is repeated fifteen times.""",
  },
  {
    "title": "Namaz of Imam Mehdi(A.T.F.S)",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=101yBQeNfSykQi5dGnnJb5HKmLprsY8_x",
    "arabic":
...
IYYAKA NAABUDU WA-IYYAKA NASTAIEN

Then, Surah al-Tawheed is recited once""",
  },
  {
    "title": "Namaz of Sundays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1yNBG50_RgDpH7pVwSvn11htJ1tErJdAQ",
    "translation":
  ...
  {
    "title": "Namaz of Mondays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1SB734zk-zjeq18Jxg_NXctiTiRDZc6Di",
    "translation":
  ...
  {
    "title": "Namaz of Tuesdays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1czSOQeJe_MX4g-Kl9ufHlX4NYqsY33xE",
    "translation":
  ...
  {
    "title": "Namaz of Wednesdays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1EaH8cUDzUoaypNfwuDLZPx9wVaW5biKb",
    "translation":
  ...
  {
    "title": "Namaz of Thursadays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1s44bhLa1lUDH4DTO70-MkcflrCwX9NSJ",
    "translation":
  ...
  {
    "title": "Namaz of Fridays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=14sRvdoseiowj0_tkOrvvx5hJKsv3JvFh",
    "translation":
    """Imam al-Hasan al-’Askari(a.s.) is also reported to have said that whoever offers on Fridays a four unit prayer; reciting in each unit Surah al-Faatehah, Surah al-Mulk, and Surah Fussilat, Almighty Allah will allow him Paradise, grant him the right to intercede for his household, and guard him against the grave pressure and the horrors on the Resurrection Day.

When the reporter asked Imam al-’Askari(a.s.) about the best time of offering these prayers, the Imam (a.s.) answered,The best time is the period between sunrise and midday (zohr).""",
  },
  {
    "title": "Namaz of Saturdays",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1aSrg-zslQD6VQvpZYVqY5hJEW_SfJOY_",
    "translation":
  ...
  {
    "title": "Namaz for Fulfilment of Needs",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1-MrirxfZSMfZybrGILnUnzhfpB2PdCjK",
    "arabic":
    """The trustworthy Shaykh al-Kulayni, may Allah have mercy upon him, reports in his book of al-Kafi that ‘Abd al-Rahim al-Qasir said: I once visited Imam al-Sadiq(a.s.) and said, “May Allah accept me as ransom for you! I have invented a formula of supplicatory prayer.”

The Imam (a.s.) answered, “Save me from your inventions! Whenever a disaster befalls you, you should have recourse to the Messenger of Allah and offer a two-unit prayer and dedicate it to him, peace be upon him and his Household.”

“How can I do that?” I asked.

The Imam (a.s.) answered, “You should bathe yourself and offer a two-unit prayer, beginning it with the prefatory part of obligatory prayers and say the tashahhud statement of obligatory prayers. When you finish saying the tashahhud and Taslim statements, you should say the following:

اَللّٰهُمَّ اَنْتَ السَّلَامُ وَ مِنْكَ السَّلَامُ وَ اِلَيْكَ يَرْجِعُ السَّلَامُ اَللّٰهُمَّ صَلِّ عَلٰى مُحَمَّدٍ وَّ اٰلِ مُحَمَّدٍ وَّ بَلِّغْ رُوْحَ مُحَمَّدٍ مِنِّىْ السَّلَامَ وَ اَرْوَاحَ الْاَئِمَّةِ الصَّادِقِيْنَ سَلَامِىْ وَارْدُدْ عَلَىَّ مِنْهُمُ السَّلَامَ وَالسَّلَامُ عَلَيْهِمْ وَ رَحْمَةُ اللّٰهِ وَ بَرَكَاتُهُ اَللّٰهُمَّ اِنَّ هَاتَيْنِ الرَّكْعَتَيْنِ هَدِيَّةٌ مِنِّىْ اِلٰى رَسُوْلِ اللّٰهِ صَلَّى اللّٰهُ عَلَيْهِ وَ اٰلِهٖ فَاَثِبْنِىْ عَلَيْهِمَا مَا اَمَّلْتُ وَ رَجَوْتُ فِيْكَ وَ فِىْ رَسُوْلِكَ يَا وَلِىَّ الْمُؤْمِنِيْنَ۔

You may then prostrate and repeat the following forty times:

يَا حَىُّ يَا قَيُّوْمُ،يَا حَيُّا لَا يَمُوْتُ،يَا حَيًّا لَاۤ اِلٰهَ اِلَّاۤ اَنْتَ،يَا ذَا الْجَلَالِ وَ الْاِكْرَامِ،يَا اَرْحَمَ‏ الرَّاحِمِيْنَ۔
...
You may then raise your head from prostration, extend your hands (towards the sky) and repeat the supplication forty times. You may then pull your hands to your neck, point out with your forefinger, and repeat the supplication forty times. You may then hold your beard with your left hand and weep, or try to weep, and say the following:

يَا مُحَمَّدُ يَا رَسُوْلَ اللّٰهِ اَشْكُوْ اِلَى اللّٰهِ وَ اِلَيْكَ حَاجَتِىْ وَ اِلٰى اَهْلِ بَيْتِكَ الرَّاشِدِيْنَ حَاجَتِىْ وَ بِكُمْ اَتَوَّجَهُ اِلَى اللّٰهِ فِىْ حَاجَتِىْ۔

You should then prostrate and repeat the following word as much as one breath can take:

يَا اَللهُ يَا اللهُ۔

You may then say the following:

صَلِّ عَلٰى مُحَمَّدٍ وَّ اٰلِ مُحَمَّدٍ۔

You may now mention your need.

If you do so, Imam al-Sadiq(a.s.) added, I guarantee that Allah the Almighty and Majestic will settle your need before you leave your place.”""",
    "transliteration":
    """The trustworthy Shaykh al-Kulayni, may Allah have mercy upon him, reports in his book of al-Kafi that ‘Abd al-Rahim al-Qasir said: I once visited Imam al-Sadiq(a.s.) and said, “May Allah accept me as ransom for you! I have invented a formula of supplicatory prayer.”
...
ALLAHUMMA ANTAA AS-SALAAMO WA MINKA AS-SLAAMO WA ILAYKA YARJIOS-SALAAMO ALLAHUMMA SALLI ALA MOHAMMADIW WA AALI MOHAMMADIN WA BALLIG RUHA WA MOHAMMADIN MINNIS-SALAAMA WA ARWAAHAL-AIMMATIS-SAADIKINA SALAAMI WA-ARDUD ALAYYA MINHUMOS-SALAAMA WAS-SALAAMO ALAYHIM WA RAHMATULLAHI WA BARAKATOHO.ALLAHUMMA INNA HAATAINIR-RAKATAINI HADIYYATUN MINNI ILAA RASOOLILLAHI SALLALAHO ALAYHI WA AALEHI FA-AASIBNI ALAYHIMAA MAA AMMALTO WA RAJAUV-TO FIKA WA FI RASOOLIKA YA WALIYYIL MOMININ.

You may then prostrate and repeat the following forty times:

YA HAYYO YA QAYYUMO,YA HAYYO LA YA MUTO,YA HAYYAN LAA ILAAHA ILLA ANTA,YA ZALJALAALI WAL IKRAAMI,YA ARHAMAR-RAHIMIN

You may then put your right cheek on the ground and repeat the aforesaid supplication forty times. You may then put your left cheek on the ground and repeat the supplication more forty times.

You may then raise your head from prostration, extend your hands (towards the sky) and repeat the supplication forty times. You may then pull your hands to your neck, point out with your forefinger, and repeat the supplication forty times. You may then hold your beard with your left hand and weep, or try to weep, and say the following:

YA MOHAMMADO YA RASOOLALAHI ASHKO ILALLAHI WA ILAYKA HAAJATI WA BIKUM ATAWAJJAHO ILALLAHI FI HAAJATI
...
SALLI ALAA MOHAMMADIW WA-AALE MOHAMMADIN
...
If you do so, Imam al-Sadiq(a.s.) added, I guarantee that Allah the Almighty and Majestic will settle your need before you leave your place.”""",
  ...
  {
    "title": "Namaz for more Sustenance",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1G96WKRlIx8jGnbreyqvfLDiMBDgHcwbX",
    "arabic":
    """It is reported that a man came to the Holy Prophet (s.a.w.a.) and said, “I have many dependants and I am suffering too much because of debts. Therefore, instruct me a supplication by which Almighty Allah will provide me sustenance so that I can settle my debts and cover the needs of my dependants.” The Holy Prophet (s.a.w.a.) taught him to do the following: You may do the ritual ablution very accurately and then offer a two unit prayer with accurate genuflection (ruku') and prostration. Upon accomplishment, you may say the following supplication:

يَا مَاجِدُ يَا وَاحِدُ يَا كَرِيْمُ اَتَوَجَّهُ اِلَيْكَ بِمُحَمَّدٍ نَبِيِّكَ نَبِىِّ الرَّحْمَةِ صَلَّى اللّٰهُ عَلَيْهِ وَ اٰلِهٖ يَا مُحَمَّدُ يَا رَسُوْلَاللّٰهِ اِنِّى اَتَوَجَّهُ بِكَ اِلَى اللّٰهِ رَبِّىْ وَ رَبِّكَ وَ رَبِّ كُلِّ شَيْئٍ وَ اَسْئَلُكَ اللّٰهُمَّ اَنْ تُصَلِّىَ عَلٰى مُحَمَّدٍ وَّ اَهْلِ بَيْتِهِ وَ اَسْئَلُكَ نَفْحَةً كَرِيْمَةً مِنْ نَفَحَاتِكَ وَ فَتْحًا يَّسِيْرًا وَ رِزْقًا وَاسِعًا اَلُمُّ بِهِ شَعَثِىْ وَ اَقْضِىْ بِهِ دَيْنِىْ وَاَسْتَعِيْنُ بِهِ عَلٰى عِيَالِىْ۔""",
    "transliteration":
    """It is reported that a man came to the Holy Prophet (s.a.w.a.) and said, “I have many dependants and I am suffering too much because of debts. Therefore, instruct me a supplication by which Almighty Allah will provide me sustenance so that I can settle my debts and cover the needs of my dependants.” The Holy Prophet (s.a.w.a.) taught him to do the following: You may do the ritual ablution very accurately and then offer a two unit prayer with accurate genuflection (ruku') and prostration. Upon accomplishment, you may say the following supplication:

YA MAJIDO YA WAAHIDO YA KARIMO ATAWAJJAHO ILAYKA BI MOHAMMADIN NABIIKA NABII-RAHMATI SALLALAAHO ALAYHI WA AALEHI YA MOHAMMADO YA RASULOOLAHI INNI ATAWAAJAHO BIKA ILAALAHI RABBI WA RABBIKA W RABBI KULLI SHAY-IN WA AS-ALOKA ALLAHUMA AN TUSALLI ALAA MOHAMMADIN WA AALE BAYTIHI WA ASALOKA NAFHATAN KARIMATAN MIN NAFHATIKA WA FATHAY-YASIRAN WA RIZQAN WASIAAN ALLOMO BIHI SHA-ASI WA AKZI BIHI DINI WA ASTAINO BIHI ALAA IYALI""",
  },
  {
    "title": "2nd Namaz for more Sustenance",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1G96WKRlIx8jGnbreyqvfLDiMBDgHcwbX",
    "arabic":
    """You Should Offer two or four units of prayer after which you may say the following supplication:

غَدَوْتُ بِحَوْلِ اللهِ وَ قُوَّتِهِ وَ غَدَوْتُ بِلَا حَوْلٍ مِّنِّىْ وَلَا قُوَّةٍ وَلٰكِنْ بِحَوْلِكَ وَ قُوَّتِكَ يَا رَبِّ اَللّٰهُمَّ اِنّى عَبْدُكَ اَلْتَمِسُ مِنْ فَضْلِكَ كَمَا اَمَرْتَنِىْ فَيَسِّرْ لِىْ ذٰلِكَ وَ اَنَا خَافِضٌ فِىْ عَافِيَتِكَ
OR You may offer a two unit prayer; in the first unit, you may recite Surah al-Faatehah once and repeat Surah al-Kawthar (No. 108) three times. In the second unit, you may recite Surah al-Faatehah once and repeat Surah al-Falaq and Surah al-Nas each three times.""",
    "transliteration":
    """It is reported that a man came to the Holy Prophet (s.a.w.a.) and said, “I have many dependants and I am suffering too much because of debts. Therefore, instruct me a supplication by which Almighty Allah will provide me sustenance so that I can settle my debts and cover the needs of my dependants.” The Holy Prophet (s.a.w.a.) taught him to do the following: You may do the ritual ablution very accurately and then offer a two unit prayer with accurate genuflection (ruku') and prostration. Upon accomplishment, you may say the following supplication:

GADAWTO BI HAWLI-ALLAHI WA QUWWATIHI WA GADAWTO BILAA HAWLIN MINNI WA LA QUWWATIN WA LAAKIN BI-HAWLIKA WA QUWWATIKA YA RABBI ALLAHUMA INNI ABDOKA AL-TAMISO MIN FAZLIKA KAMAA AMAR TANI FAYASSIR LI ZALIKA WA ANAA KHAFIZOON FI AAFIYATIKA""",
  },
  {
    "title": "Namaz of Imam Mahdi at Jamkaran Mosque",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=17AtY7cFQIybPLZKdL4cAFRitsxQaq6Bi",
    "arabic":
...
IYYAKA NAA BUDU WA IYYAKA NASTAEEM..

They may then continue reciting this Surah. The same thing may be done in the second unit. The zikr of glorifying God that are said in the genuflection (ruku') and prostrations of the prayers may be repeated seven times in this prayer. Upon accomplishment of the prayer, they may repeat the tahlil statement (i.e. LA-ILAHA ILLA’LLAHU) one hundred times and then utter the Tasbih al-Zahra’. Immediately after that, they may prostrate themselves and repeat the invocation of blessings upon the Holy Prophet and his Household one hundred times.” Imam al-Mahdi(a.s.) added, “Whoever offers this prayer will be awarded the reward of offering prayer in the Holy Ka’bah.”""",
  },
  {
    "title": "Namz to Dispel Fear of Oppressors",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=14_yNtjvbjV8SxRkmtkiYCveQioXhm-0e",
    "arabic":
...
يَا حَىُّ يَا قَيُّوْمُ يَا حَيًّا لَاۤ اِلٰهَ اِلَّا اَنْتَ بِرَحْمَتِكَ اَسْتَغِيْثُ فَصَلِّ عَلٰى مُحَمَّدٍ وَّ اٰلِ مُحَمَّدٍ وَّاَغِثْنِىْ السَّاعَةَ السَّاعَةَ۔

Upon accomplishment, you may say the following supplicatory prayer:

اَسْئَلُكَ اَللّٰهُمَّ اَنْ تُصَلِّىَ عَلٰى مُحَمَّدٍ وَّ اٰلِ مُحَمَّدٍ وَّ اَنْ تَلْطُفَ لِىْ وَ اَنْ تَغْلِبَ لِىْ وَ اَنْ تَمْكُرَلِىْ وَ اَنْ تَخْدَعَ لِىْ وَ اَنْ تَكِيْدَلِىْ وَ اَنْ تَكْفِيَنِىْ مَؤُنَةَ فَلَانُ بْنُ فُلَانٍ۔
...
YA HAYYO YA QAYYUM YA HAYYO LA ILAHA ILLA ANTA YAR HAMTEKA AS TAGEESO FASALLI ALAA MUHAMMADIN WA AALE MUHAMMADIN WA AGISNI AS SAA-ATA SAA-AT

Upon accomplishment, you may say the following supplicatory prayer:

AS-ALOKA ALLAHUMMA AN TUSALLI ALAA MUHAMMADIN WA AALE MUHAMMADIN WA AN TALTOFA LI W A TAGLIBA LI WA AN TAMKORALI WA AN TAKHDA-AA LI WA AN TAKI-DALI WA AN TAKFINI MAUNATA FALAAN-UBNU-FALAAN
...
This is the supplicatory prayer of the Holy Prophet (s.a.w.a.) on the day of the Battle of Uhud""",
  ...
  {
    "title": "Namaz for Forgiveness",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1o3i2AwXV3qqtQyqWlT8pFwfqi9k3-Df1",
    "translation": """NAMAZ FOR FORGIVENESS
Offer a two unit prayer in each unit of which you may recite Surah al-Tawheed sixty times,after Surah al-Faatehah.When you finish, your sins will be forgiven.""",
  },
  {
    "title": "Seond Namaz for Forgiveness",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1jmwtxCh9paGEZsIQ2yMu4GV2U4IW_jzB",
    "arabic":
...
لَا حَوْلَ وَ لَا قُوَّةَ اِلَّا بِاللهِ الْعَلِىِّ الْعَظِيْمِ۔
...
LAA HAWLA WALAA QUWWATA ILLA BILLAHIL ALI-IL AZEEM
...
When you stand erect again after the genuflection (ruku'), you may repeat the same statement twenty-five times. In the two prostrations of the prayer and the position of sitting between them, you may repeat the same statement twenty-five each. When you stand up for offering the second unit, you may do the same thing as exactly as you have done in the first unit. By this, you have repeated this statement three hundred times. You may then finish your prayer after uttering the statements of tashahhud and Taslim. Keeping yourself in the position of the prayer (i.e. sitting), you may raise your head towards the sky and repeat the following statement thirty times:

مِنَ الْعَبْدِ الذَّلِيْلِ اِلَى الْمَوْلَى الْجَلِيْلِ۔

You may then submit your request, and the response will come very shortly, by the permission of Almighty Allah.""",
  },
  {
    "title": "Namaz for Seeking Allah Help in the name of Bibi Fatimah",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1T_QaD4EhbsITgq5wTE67qwJ_MpesGWFz",
    "arabic":
...
يا مَوْلَاتِىْ يَا فَاطِمَةُ اَغِيْثِيْنِىْ۔
...
يَا اٰمِنًا مِنْ كُلِّ شَيْى ءٍ وَ كُلُّ شَيْى ءٍ مِنْكَ خاۤئِفٌ حَذِرٌ اَسْئَلُكَ بِاَمْنِكَ مِنْ كُلِّ شَىْءٍ وَ خَوْفِ كُلِّ شَىْءٍ مِنْكَ اَنْ تُصَلِّىَ عَلٰى مُحَمَّدٍ وَّ اَنْ تُعْطِيَنِىْ اَمَانًا لِنَفْسِىْ وَ اَهْلِىْ وَ مَالِىْ وَ وَلَدِىْ حَتّٰى لَا اَخَافَ اَحَدًا وَّ لَا اَحْذَرَ مِنْ شَىْءٍ اَبَدًا اِنَّكَ عَلٰى كُلِّ شَيْى ءٍ قَدِيْرٌ۔""",
  },
  {
    "title": "Namaz for Seeking Allah Help in the name of Prophet & Imam Ali",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1GHHu0y5Nfa6i-5aLR1Q2w6kAQmYSeAnD",
    "arabic": """The following is also quoted from this respectable book:
...
يَا مُحَمَّدُ يَا رَسُوْلَ اللّٰهِ يَا عَلِىُّ يَا سَيِّدَىِ الْمُؤْمِنِيْنَ وَالْمُؤْمِنَاتِ بِكُمَا اَسْتَغِيْثُ اِلَى اللّٰهِ تَعَالٰى يَا مُحَمَّدُ يَا عَلِىُّ اَسْتَغِيْثُ بِكُمَا يَا غَوْثَاهُ بِاللّٰهِ وَ بِمُحَمَّدٍ وَّ عَلِيٍّ وَ فَاطِمَةَ۔

You may then mention the names of the Holy Imams (a.s.). Following this, you may add the following:

بِكُمْ اَتَوَسَّلُ‏ اِلَى اللهِ تَعَالٰى۔

Once you do so, they will intercede for you to Almighty Allah to grant you His aid at that very moment, if He wills.""",
  },
  {
    "title": "Namaz for Settling Needs",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1Y_wMCY29ILNMRUJL10QSCw3Qm-P8SWHp",
    "arabic": """The following is quoted from the book of Makarim al-Akhlaq:
...
لَوْ اَنْزَلْنَا هٰذَا الْقُرْاۤنُ۔۔۔
...
If your need is not settled, you may repeat this prayer. If it is still not settled, you may repeat it once more and your need will be settled, Allah willing.""",
  ...
  {
    "title": "Namaz for Solving Difficulties",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1hpfuzjQnqNorq3oJ6kGBqLuHIMGw4SYE",
    "translation":
    """Imam al-Sadiq(a.s.) is reported to have said: When you face a difficulty, you may offer a two-unit prayer at midday (zohr). In the first unit, you may recite Surah al-Faatehah, Surah al-Tawheed, and the first three verses of Surah al-Fath (No. 48):

In the second unit, you may recite Surah al-Faatehah, Surah al-Tawheed, and Surah al-Inshirah (or al-Sharh No. 94).""",
  },
  {
    "title": "Namaz for Travel",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1mkH39JAvVtPO2mUTkYMBQ1zfGQBNnOHt",
    "arabic":
    """Method: It is 2 rak'at Namaz (Like morning prayers). To be prayed at the time of travel.

After this Namaz recite the following Dua:

بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِیْمِ

اَللّٰھُمَّ اِنِّیْۤ اَسْتَوْدِعُكَ السَّاعَۃَ نَفْسِیْ وَ اَھْلِیْ وَ مَالِیْ وَ وَلَدِیْ وَ ذُرِّیَّتِیْ وَ دُنْیَايَ وَ اٰخِرَتِیْ وَ خَاتَمَۃَ عَمَلِیْ اَللّٰھُمَّ احْفِظْ عَلَیْنَا اَللّٰھُمَ اجْعَلْنَا فِیْ جَوَارِكَ اَللّٰھُمَّ لَا تَسْلُبْنَا نِعْمَتَكَ وَ لَا تُغَیِّرْ مَا بِنَا مِنْ عَافِیَتِكَ وَ فَضْلِكَ یَا مَوْلَايَ اِنْقَطَعَ الرَّجَاۤء اِلَّا مِنْكَ وَ خَابَتِ الْاَمَالُ اِلَّا فِیْكَ اَسْئَلُكَ اِلٰھِیْ مَنْ حَقُّہٗ وَاجِبٌ عَلَیْكَ مِمَّنْ جَعَلْتَ لَہُ الْحَقَ عِنْدَكَ اَنْ تُصَلِّيَ عَلیٰ مُحَمَّدٍ وَ اٰلِ مُحَمَّدٍ اَنْ تَقْضِيَ حَاجَتِیْ۔

Then say:

مُحَمَّدٌ رَسُوْلُ اﷲِ اَمَامِیْ وَ عَلِیٌّ وَرَائِیْ وَ فَاطِمَۃُ فَوْقَ رَاسِیْ وَ الْحَسَنُ وَ الْحُسَیْنُ عَلیٰ یَسَارِیْ، وَ عَلِیٌّ و مُحَمَّدٌ وَ جَعْفَرٌ وَ مُوْسیٰ وَ عَلِیٌّ وَ مُحَمَّدٌ وَ عَلِیٌّ وَ الْحَسَنُ وَ الْحُجَّۃُ عَلَیْھِمُ السَّلَامُ حَوْلِیْ اِلٰھِیْ مَا خَلَقْتَ خَلْقًا خَیْرًا مِّنْھُمْ فَاجْعَلْ صَلَوَاتِیْ بِھِمْ مَقْبُوْلَۃً وَ دَعْوَاتِیْ بِھِمْ مُسْتَجَابَۃً وَ حَوَاۤئِجِیْ بِھِمْ مَقْضِیَّۃً وَ ذُنُوْبِیْ بِھِمْ مَغْفُوْرَۃً وَ اٰفَاتِیْ بِھِمْ مَدْفُوْعَۃً وَ اَعْدَاۤئِیْ بِھِمْ مَقْھُوْرَۃً و رِزْقِیْ بِھِمْ مَبْسُوْطَۃً اَللّٰھُمَّ صَلِّ عَلیٰ مُحَمَّدٍ وَ اٰلِ مُحَمَّدٍ۔""",
    "transliteration": """NAMAZ FOR TRAVEL

Method: It is 2 rak'at Namaz (Like morning prayers). To be prayed at the time of travel.

After this Namaz recite the following Dua:

BISMILLAHIR RAHMANIR RAHEEM ALLAAHUMMA INNEE ASTAWDE-O'KAS SAA-A'TA NAFSEE WA AHLEE WA MAALEE WA WALADEE WA ZURRIYYATEE WA DUNYAAYA WA AAKHERATEE WA KHAATAMATE A'MALEE ALLAAHUMMAH FIZ A'LAYNAA ALLAAHUMMAJ A'LNAA FEE JAWAAREKA ALLAAHUMMA LAA TASLUBNAA NE'MATEKA WA LAA TO-GHAYYERO MAA BENAA MIN A'AFEYATEKA WA FAZLEKA YAA MAWLAAYAN QATA-A'R RAJAA-O ILLAA MINKA WA KHAABATIL AMALUL AAFEEKA AS-ALOKA ELAAHEE MAN HAQQAHU WAAJEBUN A'LAYKA MIMMAN JA-A'LTA LAHUL HAQ I'NDAKA AN TOSALLEYA A'LAA MOHAMMADIN WA AALE MOHAMMADIN AN TAQZEYA HAAJATEE.

Then say:

MOHAMMADUN RASOOLUL LAAHE AMAAMEE WA A'LIYYUN WARAA-EE WA FAATEMATO FAWQA RAASEE WAL HASANO WAL HOSAYNO A'LAA YASAAREE, WA A'LIYYUN WA MOHAMMADUN WA JA'FARUN WA MOOSAA WA A'LIYYUN WA MOHAMMADUN WA A'LIYYUN WAL HASANO WAL HUJJATO A'LAYHEMUS SALAAMO HAWLEE ELAAHEE MAA KHALAQTA KHALQAN KHAYRAM MINHUM FAJ-A'L SALAWAATEE BEHIM MAQBOOLATAN WA DA'WAATEE BEHIM MUSTAJAABATAN WA HAWAA-EJEE BEHIM MAQZIYYATAN WA ZONOOBEE BEHIM MAGHFOORATAN WA AAFAATEE BEHIM MADFOO-A'TAN WA A-A'DAA-EE BEHIM MAQHOORATAN WA RIZQEE BEHIM MABSOOTATAN ALLAAHUMMA SALLE A'LAA MOHAMMADIN WA AALE MOHAMMAD.""",
  },
  {
    "title":
    "Namaz on Friday Nights Before Eidal Adha for Fulfillment of Needs",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1Zh6MZRN1jZSkPsRftJLPGAG5Y2MGLAxs",
    "arabic":
...
Then, you may pray Almighty Allah for whatever you want, and all your requests will be granted, Allah willing.""",
  ...
  {
    "title": "Namaz of Imam Sadiq to Ward of Evil",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1bXpDXH22Ucog4cQdvOW_FsI9MbTvsDHE",
    "arabic":
    """This supplicatory prayer is described as Imam al-Sadiq’s evil-averting prayer (i.e. Hijab):

يَا مَنْ اِذَا اسْتَعَذْتُ بِهِ اَعَاذَنِىْ وَ اِذَا اسْتَجَرْتُ بِهِ عِنْدَ الشَّدَاۤئِدِ اَجَارَنِىْ وَ اِذَا اسْتَغَثْتُ بِهِ عِنْدَ النَّوَاۤئِبِ اَغَاثَنِىْ وَ اِذَاسْتَنْصَرْتُ بِهِ عَلٰى عَدُوِّىْ نَصَرَنِىْ وَ اَعَانَنِىْ اِلَيْكَ الْمَفْزَعُ وَ اَنْتَ الثِّقَةُ فَاقْمَعْ عَنِّىْ مَنْ اَرَادَنِىْ وَاغْلِبْ لِىْ مَنْ كَادَنِىْ يَا مَنْ قَالَ اِنْ يَنْصُرْكُمُ اللّٰهُ فَلَا غَالِبَ لَكُمْ يَا مَنْ نَجَّا نُوْحًا مِنَ الْقَوْمِ الظَّالِمِيْنَ يَا مَنْ نَجَّا لُوْطًا مِنَ

الْقَوْمِ الْفَاسِقِيْنَ يَا مَنْ نَجَّا هُوْدًا مِنَ الْقَوْمِ الْعَادِيْنَ يَا مَنْ نَجَّا مُحَمَّدًا صَلَّى اللّٰهُ عَلَيْهِ وَ اٰلِهٖ مِنَ الْقَوْمِ الْكَافِرِيْنَ نَجِّنِىْ مِنْ اَعْدَاۤئِىْ وَ اَعْدَاۤئِكَ بِاَسْمَاۤئِكَ يَا رَحْمٰنُ يَا رَحِيْمُ لَا سَبِيْلَ لَهُمْ عَلٰى مَنْ تَعَوَّذَ بِالْقُرْاٰنِ وَاسْتَجَارَكَ بِالرَّحِيْمِ الرَّحْمٰنِ اَلرَّحْمٰنُ عَلَى الْعَرْشِ اسْتَوٰى اِنَّ بَطْشَ رَبِّكَ لَشَدِيْدٌ اِنَّهُ هُوَ يُبْدِئُ وَ يُعِيْدُ وَهُوَ الْغَفُوْرُ الْوَدُوْدُ ذُوْا الْعَرْشِ الْمَجِيْدِ فَعَالٌ لِمَا يُرِيْدُ فَاِنْ تَوَلَّوْا فَقُلْ حَسْبِىَ اللّٰهُ لَاۤ اِلٰهَ اِلَّا هُوَ عَلَيْهِ تَوَكَّلْتُ وَ هُوَ رَبُّ الْعَرْشِ الْعَظِيْمِ۔""",
  },
  {
    "title": "Namaz of Imam Kazim to Ward of Evil",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1rZHBztMWyXNluvil9wPqvnLJDNetMDKZ",
    "arabic": """This is Imam Musa ibn Ja’far al-Kazim’s evil-averting prayer:

تَوَكَّلْتُ عَلَى الْحَىِّ الَّذِىْ لَايَمُوْتُ وَتَحَصَّنْتُ بِذِى الْعِزَّةِ وَالْجَبَرُوْتِ وَاسْتَعَنْتُ بِذِى الْكِبْرِيَاۤءِ وَالْمَلَكُوْتِ مَوْلَاىَ اسْتَسْلَمْتُ اِلَيْكَ فَلَا تُسْلِمْنِىْ وَ تَوَكَّلْتُ عَلَيْكَ فَلَا تَخْذُلْنِىْ وَ لَجَاْتُ اِلٰى ظِلِّكَ الْبَسِيْطِ فَلَا تَطْرَحْنِىْ اَنْتَ الْمَطْلَبُ وَ اِلَيْكَ الْمَهْرَبُ تَعْلَمُ مَاۤ اُخْفِىْ وَ مَاۤ اُعْلِنُ وَ تَعْلَمُ خَاۤئِنَةَ الْاَعْيُنِ وَ مَا تُخْفِى الصُّدُوْرُ فَاَمْسِكْ عَنِّى اللّٰهُمَّ اَيْدِى الظَّالِمِيْنَ مِنَ الْجِنِّ وَالْاِنْسِ اَجْمَعِيْنَ وَاشْفِنِىْ وَ عَافِنِىْ يَاۤ اَرْحَمَ الرَّاحِمِيْنَ۔""",
  },
  {
    "title": "Namaz of Imam Mohd Taqi to Ward of Evil",
    "audioUrl":
    "http://docs.google.com/uc?export=open&id=1ZdolgamMY1KMAeIdNEShm-hQZKwykLW6",
    "arabic":
    """This is the evil-averting prayer (Hijab) of Imam Muhammad ibn ‘Ali al-Taqi (‘a):

اَلْخَالِقُ اَعْظَمُ مِنَ الْمَخْلُوْقِيْنَ وَ الرَّازِقُ اَبْسَطُ يَدًا مِنَ الْمَرْزُوْقِيْنَ وَ نَارُاللّٰهِ الْمُؤْصَدَةُ فِىْ عَمَدٍ مُمَدَّدَةٍ تَكِيْدُ اَفْئِدَةَ الْمَرَدَةِ وَ تَرُدُّ كَيْدَ الْحَسَدَةِ بِالْاَقْسَامِ بِالْاَحْكَامِ بِاللَّوْحِ الْمَحْفُوْظِ وَالْحِجَابِ الْمَضْرُوْبِ بِعَرْشِ رَبِّنَا الْعَظِيْمِ اِحْتَجَبْتُ وَاسْتَتَرْتُ وَاسْتَجَرْتُ وَ اعْتَصَمْتُ وَ تَحَصَّنْتُ بِالٓمٓ وَ بِكٓهٰيٰعٓصٓ وَ بِطٰهٰ وَ بِطٰسٓمٓ وَ بِحٰمٓ وَ بِحٰمٓعٓسٓقٓ وَ نٓ وَ بِطٰسٓ وَ بِقٓ وَالْقُرْاٰنِ الْمَجِيْدِ وَ اَنَّهُ لَقَسَمُ لَوْ تَعْلَمُوْنَ عَظِيْمٌ وَاللّٰهُ وَلِيّى وَ نِعْمَ الْوَكِيْلُ""",
  },
];
