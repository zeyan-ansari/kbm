...
import 'data/traslate_data.dart';
import 'data/worda_data.dart';


class EnglishToPersian extends StatelessWidget {
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => WordsPage(translate, index)));
                },
                child: Column(
                  children: [
                    ListTile(
                        ...
                        title: Text(translate[index]['name'],)),
